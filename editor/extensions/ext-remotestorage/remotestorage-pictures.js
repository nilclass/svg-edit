...
remoteStorage.defineModule('pictures', function(privateClient, publicClient) {
  ...
  Album.prototype = {
    ...
    store: function(mimeType, fileName, data, useCache) {
      return this.client.storeFile(
        mimeType,
        this._path(fileName),
        data,
        // skip the cache by default
        typeof(useCache) !== 'undefined' ? useCache : false
      ).then(function() {
    ...
    load: function(fileName) {
      return this.client.getFile(this._path(fileName));
    },
